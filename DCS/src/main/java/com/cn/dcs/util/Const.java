...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(static)|(main)|(websocket)|(fhadmin)|(web)|(fh_html_1)|(fh_static_1)|(weui-master)|(index)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
