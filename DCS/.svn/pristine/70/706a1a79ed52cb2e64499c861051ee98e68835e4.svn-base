				                    			...
				                    			<div class="ibox-content scrollbar" style="height: 100%;overflow: auto;">
				                    				...
				                    				<td>
														<table class="table" style="margin: 0px">
																...
																<tr>
																	<th colspan="4"  align="left">用例1 
																		<div style="float:right;margin-right:0px;">
																			...
																			href="javascript:editScreeningResults({value:'低',objs:[{front:'1',argFun:'',condition:'=',type:'FIXED',back:'C1,F1'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
								                         ...
								                         <table class="table" style="margin: 0px">
								                         	<thead>
															<tr><th colspan="4"  align="left">用例2 
																	<div style="float:right;margin-right:0px;">
																		<a class="dropdown-user" title="修改"  
																		href="javascript:editScreeningResults({value:'低',objs:[{front:'1',argFun:'',condition:'=',type:'FIXED',back:'C1,F2'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
											                                <i class="fa fa-wrench"></i>
											                            </a>
											                            <a title="删除" href="javascript:void(0)">
											                                <i class="fa fa-times"></i>
														...
														<table class="table" style="margin: 0px">
															<thead>
																<tr>
																	<th colspan="4"  align="left">用例1 
																		<div style="float:right;margin-right:0px;">
																			<a class="dropdown-user" title="修改"  href="javascript:editScreeningResults({value:'中',objs:[{front:'1',argFun:'',condition:'=',type:'FIXED',back:'C2,F2'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
												                                <i class="fa fa-wrench"></i>
												                            </a>
												                            <a title="删除" href="javascript:void(0)">
												                                <i class="fa fa-times"></i>
								                         ...
								                         <table class="table" style="margin: 0px">
								                         	<thead>
															<tr>
																<th colspan="4"  align="left">用例2 
																	<div style="float:right;margin-right:0px;">
																		<a class="dropdown-user" title="修改"  href="javascript:editScreeningResults({value:'中',objs:[{front:'1',argFun:'',condition:'=',type:'FIXED',back:'C2,F3'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
											                                <i class="fa fa-wrench"></i>
											                            </a>
											                            <a title="删除" href="javascript:void(0)">
											                                <i class="fa fa-times"></i>
	        							...
	        							<div class="float-e-margins">
				                    			...
				                    			<div class="ibox-content scrollbar" style="height: 100%;overflow: auto;">
				                    				...
				                    				<td>
														<table class="table" style="margin: 0px">
															<thead>
																<tr>
																	<th colspan="4"  align="left">用例1 
																		<div style="float:right;margin-right:0px;">
																			<a class="dropdown-user" title="修改"  href="javascript:editScreeningResults({value:'高',objs:[{front:'1',argFun:'',condition:'=',type:'FIXED',back:'C3,F4'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
												                                <i class="fa fa-wrench"></i>
												                            </a>
												                            <a title="删除" href="javascript:void(0)">
												                                <i class="fa fa-times"></i>
								                         ...
								                         <table class="table" style="margin: 0px">
															...
															<tr>
																	<th colspan="4"  align="left">用例2 
																		<div style="float:right;margin-right:0px;">
																			<a class="dropdown-user" title="修改"  href="javascript:editScreeningResults({value:'高',objs:[{front:'1',argFun:'',condition:'=',type:'FIXED',back:'C3,F5'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">>
												                                <i class="fa fa-wrench"></i>
												                            </a>
												                            <a title="删除" href="javascript:void(0)">
												                                <i class="fa fa-times"></i>
														...
														<td style="width:28%;padding:10px;vertical-align:top;">
															缓解措施:<textarea name="" cols="35" rows="5">机组排班时调配技术等级高的飞行员</textarea>
														</td>
														</tr>
										            	</tbody>
		        									</table>
