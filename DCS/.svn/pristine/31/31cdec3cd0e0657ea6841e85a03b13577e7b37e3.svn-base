	                    ...
	                    <div class="ibox float-e-margins" style="height: 100%;">
		                    ...
		                    <div class="ibox-content scrollbar" style="height: 100%;overflow: auto;">
								<div class="row">
										...
										<div id="tableContent" style="display: none; text-align: center;">
											<table class="table">
												...
												<tr>
													...
													<th style="width:27%;border:0px;border:0px solid #e7eaec;">T1</th>
													<th style="width:27%;border:0px;border:0px solid #e7eaec;"></th>
												</tr>
												</thead>
												<tbody>
											...
											<table class="table">
												...
												<tr>
													...
													<th style="border:0px;">Poor</th>
													<td style="border:1px solid #e7eaec;"><input value="7" style="width: 30px;text-align: center;"></td>
													<td style="border:1px solid #e7eaec;"><input value="6" style="width: 30px;text-align: center;"></td>
													<td style="border:1px solid #e7eaec;"><input value="5" style="width: 30px;text-align: center;"></td>
												</tr>
												<tr>
													<th style="border:0px;">T2</th>
													<th style="border:0px;">Mid</th>
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="5" style="width: 30px;text-align: center;"></td>
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="4" style="width: 30px;text-align: center;"></td>
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="3" style="width: 30px;text-align: center;">
													</td>
												</tr>
												<tr>
													<th style="border:0px;"></th>
													...
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="2" style="width: 30px;text-align: center;">
													</td>
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="2" style="width: 30px;text-align: center;">
													</td>
											...
											<table class="table">
												...
												<tr>
													...
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="4" style="width: 30px;text-align: center;"></td>
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="2" style="width: 30px;text-align: center;"></td>
													<td style="border:0px;border:1px solid #e7eaec;">
														<input value="1" style="width: 30px;text-align: center;">
													</td>
												</tr>
												<tr>
													<th style="border:0px;"></th>
									...
									<div class="" style="margin-top:165px; font-weight: bold;">
										<p>T1：经验配对</p>
										<p>T2：技术级别组合</p>
										<p>T3：机组英文程度</p>
									</div>
