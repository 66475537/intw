				                    			...
				                    			<div class="ibox-content scrollbar" style="height: 100%;overflow: auto;">
				                    				...
				                    				<td>
														<table class="table" style="margin: 0px">
															<thead>
																<tr><th colspan="4"  align="left">用例1</th></tr>
									                            <tr>
									                            	<th>运行参数</th>
									                                <th>对比条件</th>
									                                <th>参考值</th>
						                    	...
						                    	<div class="ibox-title" style="border-width: 0 0 0;">
							                        <div class="ibox-tools" style="text-align: left;font-size: 16px;">
							                        	<div style="float: left;">
							                        		<strong>
							                        		中-风险识别-规则定义&nbsp;&nbsp;&nbsp;&nbsp;</strong>
							                        		临界值&nbsp;<input type="text" name="lingjiezhi" maxlength="3" value="5" style="width:40px"/>&nbsp;-&nbsp;<input type="text" name="lingjiezhi" maxlength="3" value="8" style="width:40px"/>
						                    	...
						                    	<div class="ibox-title" style="border-width: 0 0 0;">
							                        <div class="ibox-tools" style="text-align: left;font-size: 16px;">
							                        	<div style="float: left;">
							                        		<strong>
							                        		高-风险识别-规则定义&nbsp;&nbsp;&nbsp;&nbsp;</strong>
							                        		临界值&nbsp;<input type="text" name="lingjiezhi" maxlength="3" value="9" style="width:40px"/>&nbsp;-&nbsp;<input type="text" name="lingjiezhi" maxlength="9" value="10" style="width:40px"/>
