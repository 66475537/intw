                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                                <p></p>
                                <div class="form-group"><label class="col-lg-2 control-label">原因</label>
                                    <div class="col-lg-10">
                                        ...
                                        <span class="help-block m-b-none">原因是必选项</span>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">描述</label>
                                    <div class="col-lg-10">
                                        <textarea id="details" placeholder="请填入描述" class="form-control" rows="10"></textarea>
                                        <span class="help-block m-b-none">描述是必填项</span>
                                    </div>
                                </div>
