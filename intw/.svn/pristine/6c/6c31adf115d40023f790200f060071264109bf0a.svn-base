	...
	<body>
				                    			...
				                    			<div class="ibox-content scrollbar" style="height: 100%;overflow: auto;">
				                    				...
				                    				<td>
														<table class="table" style="margin: 0px">
															<thead>
																<tr><th colspan="4"  align="left">用例1
																<div style="float:right;margin-right:0px;">
																			<a class="dropdown-user" title="修改"  
																			href="javascript:editScreeningResults({value:'低',objs:[{front:'9',argFun:'',condition:'=',type:'FIXED',back:'C1,F1'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
														...
														<table class="table" style="margin: 0px">
															<thead>
																<tr>
																	...
																	<div style="float:right;margin-right:0px;">
																			<a class="dropdown-user" title="修改"  
																			href="javascript:editScreeningResults({value:'中',objs:[{front:'9',argFun:'',condition:'=',type:'FIXED',back:'C1,F1'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
												                                <i class="fa fa-wrench"></i>
												                            </a>
												                            <a title="删除" href="javascript:void(0)">
												                                <i class="fa fa-times"></i>
														...
														<table class="table" style="margin: 0px">
															<thead>
																<tr>
																	...
																	<div style="float:right;margin-right:0px;">
																			<a class="dropdown-user" title="修改"  
																			href="javascript:editScreeningResults({value:'高',objs:[{front:'9',argFun:'',condition:'=',type:'FIXED',back:'C1,F1'},{front:'2',argFun:'',condition:'=',type:'FIXED',back:'2'}]})">
												                                <i class="fa fa-wrench"></i>
												                            </a>
												                            <a title="删除" href="javascript:void(0)">
												                                <i class="fa fa-times"></i>
		...
		var zTreeObj;
        	...
        	function zTreeOnAsyncSuccess(event, treeId, treeNode){
            	var node = zTreeObj.getNodeByParam("riskId","${myFormulaDef.riskId}");
