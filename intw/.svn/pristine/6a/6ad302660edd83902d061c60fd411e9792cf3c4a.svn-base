						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form class="form-horizontal">
									<p></p>
									<div class="form-group"><label class="col-lg-2 control-label">天气报文</label>
										<div class="col-lg-10">
											<textarea id="weatherInfo" placeholder="请填入天气报文" class="form-control" rows="10"></textarea>
											<span class="help-block m-b-none">天气报文是必填项</span>
										</div>
									</div>
		...
		<script type="text/javascript">
			$(function(){
				...
				$('#submit').click(function () {
				    ...
				    var weatherInfo = $('#weatherInfo').val();
		            $.ajax({
		                url:'${ctx}/notice/addWeatherMessage.do',
