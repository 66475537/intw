...
define("esri/toolbars/draw", "dojo/_base/declare dojo/_base/lang dojo/_base/array dojo/_base/connect dojo/_base/Color dojo/_base/window dojo/has dojo/sniff dojo/keys dojo/dom-construct dojo/dom-style dojo/dom-geometry ../kernel ../sniff ./_toolbar ../symbols/SimpleMarkerSymbol ../symbols/SimpleLineSymbol ../symbols/SimpleFillSymbol ../graphic ../geometry/jsonUtils ../geometry/webMercatorUtils ../geometry/Polyline ../geometry/Polygon ../geometry/Multipoint ../geometry/Rect dojo/i18n!../nls/jsapi".split(" "),
    function (H, n, z, q, x, y, r, B, I, C, D, J, K, O, L, E, w, F, t, M, N, u, s, A, G, v) {
        var h = H(L, {
            declaredClass: "esri.toolbars.Draw",
            _eventMap: {"draw-complete": !0, "draw-end": ["geometry"]},
            constructor: function (c, a) {
                this.markerSymbol = new E(E.STYLE_SOLID, 10, new w(w.STYLE_SOLID, new x([255, 0, 0]), 2), new x([0, 0, 0, 0.25]));
                this.lineSymbol = new w(w.STYLE_SOLID, new x([255, 0, 0]), 2);
                this.fillSymbol = new F(F.STYLE_SOLID, new w(w.STYLE_SOLID, new x([255, 0, 0]), 2), new x([0, 0, 0, 0.25]));
                this._points = [];
                this._mouse = !r("esri-touch") && !r("esri-pointer");
                this._defaultOptions = {showTooltips: !0, drawTime: 75, tolerance: 8, tooltipOffset: 15};
                this._options = n.mixin(n.mixin({}, this._defaultOptions), a || {});
                if (B("ios") || B("android"))this._options.showTooltips = !1;
                this._onKeyDownHandler = n.hitch(this, this._onKeyDownHandler);
                this._onMouseDownHandler = n.hitch(this, this._onMouseDownHandler);
                this._onMouseUpHandler = n.hitch(this, this._onMouseUpHandler);
                this._onClickHandler = n.hitch(this, this._onClickHandler);
                this._onMouseMoveHandler = n.hitch(this, this._onMouseMoveHandler);
                this._onMouseDragHandler = n.hitch(this, this._onMouseDragHandler);
                this._onDblClickHandler = n.hitch(this, this._onDblClickHandler);
                this._updateTooltip = n.hitch(this, this._updateTooltip);
                this._hideTooltip = n.hitch(this, this._hideTooltip);
                this._redrawGraphic = n.hitch(this, this._redrawGraphic)
            },
            _geometryType: null,
            ...
            activate: function (c, a) {
                ...
                var b = this.map, d = q.connect, g = h;
                this._options = n.mixin(n.mixin({}, this._options), a || {});
                ...
                switch (c) {
                    ...
                    case g.FREEHAND_POLYGON:
                        ...
                        r("esri-touch") && !r("esri-pointer") && (this._onMouseDownHandler2_connect = d(b, "onSwipeStart", this._onMouseDownHandler),
            ...
            finishDrawing: function () {
                ...
                switch (this._geometryType) {
                    ...
                    case d.POLYGON:
                        ...
                        !s.prototype.isClockwise(a) && !this.respectDrawingVertexOrder && (console.debug(this.declaredClass + " :  Polygons drawn in anti-clockwise direction will be reversed to be clockwise."), a.reverse());
                        c.addRing(a);
                        break;
                    case d.MULTI_POINT:
                        c = new A(b), z.forEach(a, function (a) {
                            c.addPoint(a)
                        })
                }
            ...
            _drawEnd: function (c) {
                if (c) {
                    ...
                    this.onDrawEnd(c);
                    a && (a.isWebMercator() ? b = N.webMercatorToGeographic(c, !0) : 4326 === a.wkid && (b = M.fromJson(c.toJson())));
            ...
            _normalizeRect: function (c, a, b) {
                ...
                var h = Math.abs(d -
                    g), l = Math.abs(c - a);
                return {x: Math.min(d, g), y: Math.max(c, a), width: h, height: l, spatialReference: b}
            },
            _onMouseDownHandler: function (c) {
                ...
                switch (this._geometryType) {
                    case d.LINE:
                        this._graphic = a.graphics.add(new t(new u({
                    ...
                    case d.FREEHAND_POLYLINE:
                        ...
                        this._graphic = a.graphics.add(new t(b, this.lineSymbol), !0);
                        a.snappingManager && a.snappingManager._setGraphic(this._graphic);
                        break;
                    case d.CIRCLE:
                    case d.ELLIPSE:
                    ...
                    case d.FREEHAND_POLYGON:
                        this._oldPoint = c.screenPoint, b = new s(g), b.addRing(this._points), this._graphic = a.graphics.add(new t(b, this.fillSymbol),
                            !0), a.snappingManager && a.snappingManager._setGraphic(this._graphic)
                }
                r("esri-touch") && c.preventDefault()
            },
            ...
            _onMouseDragHandler: function (c) {
                if (this._graphic || this._points.length)if (r("esri-touch") && !this._points.length)c.preventDefault(); else {
                    this._dragged = !0;
                    var a;
                    this.map.snappingManager && (a = this.map.snappingManager._snappingPoint);
                    var b = this._points[0], d = a || c.mapPoint, g = this.map, k = g.spatialReference;
                    a = this._graphic;
                    var l = h, m = g.toScreen(b), f = g.toScreen(d), e = [], e = f.x - m.x, f = f.y - m.y, p = Math.sqrt(e * e + f * f);
                    switch (this._geometryType) {
                        case l.CIRCLE:
                            this._hideTooltip();
                            a.geometry = s.createCircle({center: m, r: p, numberOfPoints: 60, map: g});
                        ...
                        case l.TRIANGLE:
                            this._hideTooltip();
                            e = [[0, -p], [0.8660254037844386 * p, 0.5 * p], [-0.8660254037844386 * p, 0.5 * p], [0, -p]];
                        ...
                        case l.ARROW:
                            ...
                            k = 0.25 * p / (f / e);
                            p *= 0.25 * b;
                            e = [[e, f], [e - d * (1 + 24 / k), f + 24 * g - p], [e - d * (1 + 12 / k), f + 12 * g - p], [-12 * b, 12 * g], [12 * b, -12 * g], [e - d * (1 - 12 / k), f - 12 * g - p], [e - d * (1 - 24 / k),
                                f - 24 * g - p], [e, f]];
                            a.geometry = this._toPolygon(e, m.x, m.y);
                            a.setGeometry(a.geometry);
                            break;
                        case l.LEFT_ARROW:
                            this._hideTooltip();
                            e = 0 >= e ? [[e, 0], [0.75 * e, f], [0.75 * e, 0.5 * f], [0, 0.5 * f], [0, -0.5 * f], [0.75 * e, -0.5 * f], [0.75 * e, -f], [e, 0]] : [[0, 0], [0.25 * e, f], [0.25 * e, 0.5 * f], [e, 0.5 * f], [e, -0.5 * f], [0.25 * e, -0.5 * f], [0.25 * e, -f], [0, 0]];
                            a.geometry = this._toPolygon(e, m.x, m.y);
                            a.setGeometry(a.geometry);
                            break;
                        case l.RIGHT_ARROW:
                            this._hideTooltip();
                            e = 0 <= e ? [[e, 0], [0.75 * e, f], [0.75 * e, 0.5 * f], [0, 0.5 * f], [0, -0.5 * f], [0.75 * e, -0.5 * f], [0.75 *
                            e, -f], [e, 0]] : [[0, 0], [0.25 * e, f], [0.25 * e, 0.5 * f], [e, 0.5 * f], [e, -0.5 * f], [0.25 * e, -0.5 * f], [0.25 * e, -f], [0, 0]];
                            a.geometry = this._toPolygon(e, m.x, m.y);
                            a.setGeometry(a.geometry);
                            break;
                        case l.UP_ARROW:
                            this._hideTooltip();
                            e = 0 >= f ? [[0, f], [-e, 0.75 * f], [-0.5 * e, 0.75 * f], [-0.5 * e, 0], [0.5 * e, 0], [0.5 * e, 0.75 * f], [e, 0.75 * f], [0, f]] : [[0, 0], [-e, 0.25 * f], [-0.5 * e, 0.25 * f], [-0.5 * e, f], [0.5 * e, f], [0.5 * e, 0.25 * f], [e, 0.25 * f], [0, 0]];
                            a.geometry = this._toPolygon(e, m.x, m.y);
                            a.setGeometry(a.geometry);
                            break;
                        case l.DOWN_ARROW:
                        ...
                        case l.RECTANGLE:
                            ...
                            break;
                        case l.LINE:
                            a.setGeometry(n.mixin(a.geometry, {paths: [[[b.x, b.y], [d.x, d.y]]]}));
                            break;
                        case l.EXTENT:
                            a && g.graphics.remove(a,
                                !0);
                            a = new G(this._normalizeRect(b, d, k));
                            a._originOnly = !0;
                            this._graphic = g.graphics.add(new t(a, this.fillSymbol), !0);
                            g.snappingManager && g.snappingManager._setGraphic(this._graphic);
                            break;
                        case l.FREEHAND_POLYLINE:
                            this._hideTooltip();
            ...
            _canDrawFreehandPoint: function (c) {
                ...
                var a = this._oldPoint.x - c.screenPoint.x, b = this._oldPoint.y - c.screenPoint.y, d = this._options.tolerance;
            ...
            _onMouseUpHandler: function (c) {
                if (!this._dragged || !this._graphic)this._clear(); else {
                    0 === this._points.length && this._points.push(c.mapPoint.offset(0, 0));
                    var a;
                    this.map.snappingManager && (a = this.map.snappingManager._snappingPoint);
                    var b = this._points[0];
                    a = a || c.mapPoint;
                    var d = this.map.spatialReference, g = h, k;
                    switch (this._geometryType) {
                        case g.CIRCLE:
                        case g.ELLIPSE:
                        case g.TRIANGLE:
                        ...
                        case g.RECTANGLE:
                            ...
                            break;
                        case g.LINE:
                            k = new u({paths: [[[b.x, b.y], [a.x, a.y]]], spatialReference: d});
                            break;
                        case g.EXTENT:
                            k = (new G(this._normalizeRect(b, a, d))).getExtent();
                            break;
                        case g.FREEHAND_POLYLINE:
                            k = new u(d);
                            ...
                            break;
                        case g.FREEHAND_POLYGON:
                            k = new s(d), b = [].concat(this._points, [a.offset(0, 0), this._points[0].offset(0, 0)]), !s.prototype.isClockwise(b) && !this.respectDrawingVertexOrder && (console.debug(this.declaredClass + " :  Polygons drawn in anti-clockwise direction will be reversed to be clockwise."),
                                b.reverse()), k.addRing(b)
                    }
                    r("esri-touch") && c.preventDefault();
                    this._clear();
                    this._drawEnd(k)
            ...
            _onClickHandler: function (c) {
                ...
                switch (this._geometryType) {
                    case d.POINT:
                        ...
                        break;
                    case d.POLYLINE:
                        1 === this._points.length ? (b = new u(a.spatialReference), b.addPath(this._points), this._graphic = a.graphics.add(new t(b,
                            this.lineSymbol), !0), a.snappingManager && a.snappingManager._setGraphic(this._graphic), this._onMouseMoveHandler_connect = q.connect(a, "onMouseMove", this._onMouseMoveHandler), this._tGraphic = a.graphics.add(new t(new u({
                            paths: [[[c.x, c.y], [c.x, c.y]]],
                            spatialReference: a.spatialReference
                        }), this.lineSymbol), !0)) : (this._graphic.geometry._insertPoints([c.offset(0, 0)], 0), this._graphic.setGeometry(this._graphic.geometry).setSymbol(this.lineSymbol), a = this._tGraphic, b = a.geometry, b.setPoint(0, 0, c.offset(0, 0)), b.setPoint(0,
                            1, c.offset(0, 0)), a.setGeometry(b));
                        break;
                    case d.POLYGON:
                        1 === this._points.length ? (b = new s(a.spatialReference), b.addRing(this._points), this._graphic = a.graphics.add(new t(b, this.fillSymbol), !0), a.snappingManager && a.snappingManager._setGraphic(this._graphic), this._onMouseMoveHandler_connect = q.connect(a, "onMouseMove", this._onMouseMoveHandler), this._tGraphic = a.graphics.add(new t(new u({
                            paths: [[[c.x, c.y], [c.x, c.y]]],
                            spatialReference: a.spatialReference
                        }), this.fillSymbol), !0)) : (this._graphic.geometry._insertPoints([c.offset(0,
                    ...
                    case d.CIRCLE:
                        this._clear();
                        this._drawEnd(s.createCircle({center: b, r: 48, numberOfPoints: 60, map: a}));
                        break;
                    case d.ELLIPSE:
                        this._clear(), this._drawEnd(s.createEllipse({
                            center: b, longAxis: 48, shortAxis: 24, numberOfPoints: 60,
                            map: a
                        }))
                }
            ...
            _toPolygon: function (c, a, b) {
                var d = this.map, g = new s(d.spatialReference);
                g.addRing(z.map(c, function (c) {
            ...
            _onDblClickHandler: function (c) {
                ...
                r("esri-touch") && b.push(c.mapPoint);
                var k = b[b.length - 1], l = b[b.length - 2], b = k && l && k.x === l.x && k.y === l.y ? b.slice(0,
                    b.length - 1) : b.slice(0, b.length);
                switch (this._geometryType) {
                    case g.POLYLINE:
                    ...
                    case g.POLYGON:
                        ...
                        !s.prototype.isClockwise(c) && !this.respectDrawingVertexOrder && (console.debug(this.declaredClass +
                            " :  Polygons drawn in anti-clockwise direction will be reversed to be clockwise."), c.reverse());
                        a.addRing(c);
                        break;
                    case g.MULTI_POINT:
                        a = new A(d), z.forEach(b, function (b) {
                            a.addPoint(b)
                        })
                }
                q.disconnect(this._onMouseMoveHandler_connect);
            ...
            _onKeyDownHandler: function (c) {
                c.keyCode === I.ESCAPE && (q.disconnect(this._onMouseMoveHandler_connect), this._clear(), this._setTooltipMessage(0))
            },
            _toggleTooltip: function (c) {
                this._options.showTooltips && (c ? this._tooltip ||
                ...
                this._tooltip && (q.disconnect(this._onTooltipMouseEnterHandler_connect), q.disconnect(this._onTooltipMouseLeaveHandler_connect), q.disconnect(this._onTooltipMouseMoveHandler_connect), C.destroy(this._tooltip), this._tooltip = null))
            },
            ...
            _setTooltipMessage: function (c) {
                ...
                if (a) {
                    ...
                    switch (this._geometryType) {
                        ...
                        case h.ELLIPSE:
                            b =
                                v.toolbars.draw.addShape;
                            break;
                        case h.LINE:
                        case h.EXTENT:
                        case h.FREEHAND_POLYLINE:
                        case h.FREEHAND_POLYGON:
                            b = v.toolbars.draw.freehand;
                            break;
                        case h.POLYLINE:
                        case h.POLYGON:
                            b = v.toolbars.draw.start;
                            1 === c ? b = v.toolbars.draw.resume : 2 <= c && (b = v.toolbars.draw.complete);
                            break;
                        case h.MULTI_POINT:
                            b = v.toolbars.draw.addMultipoint, 1 <= c && (b = v.toolbars.draw.finish)
                    }
                    a.innerHTML = b
                }
            },
            _updateTooltip: function (c) {
                ...
                if (a) {
                    var b;
                    c.clientX || c.pageY ? (b = c.clientX, c = c.clientY) : (b = c.clientX + y.body().scrollLeft -
                        y.body().clientLeft, c = c.clientY + y.body().scrollTop - y.body().clientTop);
                    a.style.display = "none";
                    D.set(a, {left: b + this._options.tooltipOffset + "px", top: c + "px"});
                    a.style.display = ""
                }
            },
        ...
        r("extend-esri") && n.setObject("toolbars.Draw", h, K);
        return h
    });