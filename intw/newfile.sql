...
DROP TABLE IF EXISTS BI_TERMINAL_VAL_RULE;
...
(
	...
	FORMULA_DEF_NAME varchar(32) NOT NULL,
	VALUE_TABLE varchar(32) NOT NULL,
	VALUE_FIELD varchar(32) NOT NULL,
	VALUE_NAME varchar(64),
	GET_ROW_COUNT varchar(32),
	ORDERBYS varchar(128),
	ORDERBY_FIELD varchar(128),
	REMARK varchar(1024),
...
CREATE TABLE BI_TERMINAL_VAL_RULE
(
	ID varchar(32) NOT NULL,
...
ALTER TABLE BI_TERMINAL_VAL_RULE
	ADD FOREIGN KEY (FORMULA_DEF_ID)
	REFERENCES BI_FORMULA_DEF (FORMULA_DEF_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
